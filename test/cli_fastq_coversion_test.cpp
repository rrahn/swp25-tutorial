...
{
    app_test_result const result = execute_app("swp25-tutorial");
...
{
    app_test_result const result = execute_app("swp25-tutorial", "-v");
...
{
    app_test_result const result = execute_app("swp25-tutorial", data("in.fastq"));
...
{
    app_test_result const result = execute_app("swp25-tutorial", data("in.fastq"), "-v");
...
{
    app_test_result const result = execute_app("swp25-tutorial", data("in.fastq"), "-o", "out.fasta");
...
{
    app_test_result const result = execute_app("swp25-tutorial", data("in.fastq"), "-o", "");
...
{
    app_test_result const result = execute_app("swp25-tutorial", data("in.fastq"), "-o", "does_not_exist/out.fasta");
